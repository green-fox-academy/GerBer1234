...
int main(void) {
	...
	;
	tim_handle2.Instance = TIM5;
	tim_handle2.Init.Period = 40000;
	...
	while (1) {
		...
		if (cnt1 > 0 && cnt1 < 10000) {
			HAL_GPIO_WritePin(GPIOI, GPIO_PIN_0, GPIO_PIN_RESET);
		} else if (cnt1 > 10000 && cnt1 < 20000) {            //yellow
			HAL_GPIO_WritePin(GPIOI, GPIO_PIN_0, GPIO_PIN_SET);
		} else if (cnt1 > 20000 && cnt1 < 30000) {
			HAL_GPIO_WritePin(GPIOI, GPIO_PIN_0, GPIO_PIN_RESET);
		} else {
			HAL_GPIO_WritePin(GPIOI, GPIO_PIN_0, GPIO_PIN_SET);
		}
